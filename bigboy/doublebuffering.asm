...
BUFFER_CHUNK_LENGTH equ 12 ;todo GAME_WINDOW_WIDTH / 2
SEG_SIZE equ 0x600
...
drawgamewindow:
    ld (stack_ptr),sp ; cache correct stack_ptr address
    ...
    ld sp,(stack_ptr) ;restore cached stack_ptr address