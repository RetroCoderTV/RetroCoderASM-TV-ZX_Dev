...
xfer: 
    ...
    ;starts from Character line 8 (lines 0-7 are for UI bar).
    ;Character Line 8:
...
SCREEN_BUFFER_END_UB equ 0x96 ;it actually ends one before this, we will get out of loops if reach this figure
PIXEL_MEM_START_UB equ 0x40
PLAY_AREA_PIXEL_MEMORY_START_UB equ 0x40 ;if we start from here we are using approx 2/3 of height of screen. It uses 0xfff (4095) bytes
