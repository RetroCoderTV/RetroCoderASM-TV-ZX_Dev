...
playersprite:
    ...
    db %10100111, %11001000
    db %10101110, %01001000
    db %10100100, %10101000
    db %00010010, %01001000
    db %11101001, %10010000
    db %00000111, %11100000
    db %11110000, %00000000
    db %11110110, %11000000
    db %00000110, %00000000
    db %11110111, %10101110
    db %11110011, %10101110
    db %01110100, %00001000
    db %00000111, %11000000
    db %01110011, %11110000
    db %10101001, %11111000
    db %00000000, %00011100
    db %00000000, %01011100
    db %00000000, %10000000
    db %00000000, %11011100
